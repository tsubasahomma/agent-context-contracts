...
- Entrypoint, surface, or platform-specific files affected:
...
| Claim | Status | Evidence | Limitations or residual risk |
| --- | --- | --- | --- |
...
- Local issue-linking or closure syntax, if any, follows project-local or selected-surface policy:
